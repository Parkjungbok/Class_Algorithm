namespace _06.Heap
{
    internal class Program
    {
        ...
        // 힙 구현
        // 힙은 노드들이 트리의 왼쪽부터 채운 완전 이진트리를 구조를 가지며
        ...
        static void Main(string[] args)
        {
            ...
            pq.Enqueue("환자1 - 감기(30년뒤)", 5);
            pq.Enqueue("환자2 - 타박상(60년뒤)", 8);
            pq.Enqueue("환자3 - 심장마비(1분뒤)", 1);
            ...
            pq.Enqueue("환자4 - 타박상(60년뒤)", 8);
            pq.Enqueue("환자5 - 심장마비(1분뒤)", 1);
